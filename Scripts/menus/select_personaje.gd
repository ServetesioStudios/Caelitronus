...
func seleccionar_personaje(tipo: GameManager.TipoCaelius) -> void:
	...
	match tipo:
		GameManager.TipoCaelius.PENA:
			PJ_pena.add_theme_stylebox_override("normal",PJ_pena.get_theme_stylebox("hover"))
		...
		GameManager.TipoCaelius.IRA:
			PJ_ira.add_theme_stylebox_override("normal",PJ_ira.get_theme_stylebox("hover"))
		...
		GameManager.TipoCaelius.EGO:
			PJ_ego.add_theme_stylebox_override("normal",PJ_ego.get_theme_stylebox("hover"))
